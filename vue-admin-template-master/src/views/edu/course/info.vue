    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="课程类别">
        ...
        <el-select v-model="courseInfo.subjectId" placeholder="二级分类">
          <el-option v-for="subject in subjectTwoList" :key="subject.value" :label="subject.title" :value="subject.id"/>
        </el-select>
      </el-form-item>
...
<script>
  ...
  export default {
    data() {
      return {
        ...
        courseInfo: {
          ...
          lessonNum: 0,
          description: '',
          cover: 'https://edu-client.oss-cn-beijing.aliyuncs.com/cover_default.jpg',
          price: 0
        },
        BASE_API: process.env.BASE_API,
        teacherList: [],  //封装所有讲师数据
        subjectOneList: [],  //封装课程分类数据
        subjectTwoList: [],
        courseId: ''
    ...
    methods: {
          ...
          .then(response => {
            ...
            subject.getSubjectList()
              .then(response => {
                ...
                // 3.遍历所有一级分类，并比较courseInfo里面的一级分类id和所有的一级分类id
      ...
      //点击一级课程分类下拉列表并选择，触发change，显示二级分类内容
