                          ...
                          <li class="lh-menu-stair" v-for="chapter in chapterVideoList" :key="chapter.id">
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="video in chapter.children" :key="video.id">
                                <a :href="'/player/'+video.videoSourceId" :title="video.title" target="_self">
                                  <span class="fr">
                ...
                <li class="unBr">
                  ...
                  <div class="of">
                    <section class="n-reply-wrap">
                      <fieldset>
                        <textarea name="" v-model="eduComment.content" placeholder="输入您要评论的文字"
...
<script>
  ...
  export default {
    ...
    created() {
      this.eduComment.courseId = this.$route.params.id
      this.initComment()
      this.initCourseInfo()
    },
    methods: {
      ...
      initComment() {
        commentApi.getCommentListPage(this.page, this.limit, this.$route.params.id).then(response => {
      ...
      addComment() {
        ...
        commentApi.addComment(this.eduComment).then(response => {
